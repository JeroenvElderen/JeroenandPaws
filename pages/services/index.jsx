...
const services = [
  {
    ...
    label: "Daily strolls",
    description:
      "Calm, enriching neighborhood walks with plenty of sniff time.",
...
const careHighlights = [
  {
    ...
    description:
      "Gentle handling, decompression time, and consent-based care in every outing.",
  },
  {
    title: "Thoughtful pacing",
    description:
      "Routes and play styles matched to your dog’s mood, mobility, and preferences.",
  },
  {
    title: "Transparent updates",
    description:
      "GPS logs, photos, and real-talk notes so you always know how the day went.",
  },
];
    ...
    <main className="services-page">
        ...
        <div className="container services-hero__inner">
          <div className="hero-copy">
            ...
            <p className="paragraph_large text-color_secondary">
              Explore experiences designed to match your dog’s personality and
              your schedule.
            </p>
          ...
          <div className="hero-card">
            ...
            <p className="hero-card__meta">
              Unhurried neighborhood walks with plenty of sniff time.
            </p>
            ...
            {services.map((service) => (
              <article key={service.path} className="service-card">
                <div className="service-card__header">
                  ...
                  <div className="heading_h5 margin-bottom_none">
                    {service.label}
                  </div>
                </div>
                <p className="paragraph_small text-color_secondary">
                ...
                <div className="service-card__actions">
                  ...
                  >
                    ...
                    <span className="service-card__button-label">
                      {service.cta}
                    </span>
                  </button>
                </div>
      ...
      <style jsx>{`
        ...
        .service-card {
          ...
          background: radial-gradient(
              circle at 20% 20%,
              rgba(166, 140, 255, 0.12),
              transparent 35%
            ),
            radial-gradient(
              circle at 85% 10%,
              rgba(123, 214, 255, 0.1),
              transparent 40%
            ),
            linear-gradient(
              145deg,
        ...
        .service-card::before {
          ...
          background: linear-gradient(
            135deg,
            rgba(124, 211, 255, 0.16),
            rgba(124, 69, 243, 0.18)
          );
          opacity: 0;
        ...
        .service-card__button {
          ...
          background: linear-gradient(
            120deg,
            var(
              --ai-gen-82921b10-4b39-48f0-b346-808cf4903d29-1759229239308---background-color--bg-accent-primary,
              #7c45f3
            ),
            var(
              --ai-gen-82921b10-4b39-48f0-b346-808cf4903d29-1759229239308---core-accent-color--accent-primary-hover,
              #a47ef7
            )
          );
          color: #fff;
        ...
        .service-card__button:hover {
          ...
          background: linear-gradient(
            ...
            #9f7ff7,
            var(
              --ai-gen-82921b10-4b39-48f0-b346-808cf4903d29-1759229239308---core-accent-color--accent-primary,
              #7c45f3
            )
          );
        ...
        .pillar-card__glow {
          ...
          background: radial-gradient(
              circle at 10% 10%,
              rgba(123, 214, 255, 0.18),
              transparent 35%
            ),
            radial-gradient(
              circle at 90% 80%,
              rgba(166, 140, 255, 0.14),
              transparent 40%
            );
          opacity: 0.9;
          pointer-events: none;
