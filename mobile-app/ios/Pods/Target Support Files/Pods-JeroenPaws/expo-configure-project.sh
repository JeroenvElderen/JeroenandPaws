...
with_node \
  ...
  --target "/Users/jeroen/dev/JeroenandPaws/mobile-app/ios/Pods/Target Support Files/Pods-JeroenPaws/ExpoModulesProvider.swift" \
  --entitlement "/Users/jeroen/dev/JeroenandPaws/mobile-app/ios/JeroenPaws/JeroenPaws.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-location" "expo-notifications"
