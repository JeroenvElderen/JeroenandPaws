...
const DocumentIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor">
    <path d="m25.7 9.3-7-7A.9.9 0 0 0 18 2H8a2.006 2.006 0 0 0-2 2v24a2.006 2.006 0 0 0 2 2h16a2.006 2.006 0 0 0 2-2V10a.9.9 0 0 0-.3-.7M18 4.4l5.6 5.6H18ZM24 28H8V4h8v6a2.006 2.006 0 0 0 2 2h6Z" strokeLinejoin="round"></path>
  </svg>
);

const ArrowIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 16 16" fill="none">
    <path d="M2 8H14.5M14.5 8 8.5 2M14.5 8 8.5 14" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"></path>
  </svg>
);
                              ...
                              <ul role="list" className="mega-nav_list w-list-unstyled">
                                <li className="margin-bottom_none">
                                  <Link to="/services/daily-strolls" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a018c-d66a6ef8">
                                      <div>
                                ...
                                <li className="margin-bottom_none">
                                  <Link to="/services/group-adventures" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a0197-d66a6ef8">
                                      <div>
                                ...
                                <li className="margin-bottom_none">
                                  <Link to="/services" className="mega-nav_link-item w-inline-block">
                                    <div className="icon is-medium on-accent-primary">
                                      <DocumentIcon />
                                    </div>
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a01a2-d66a6ef8">
                                      <div>
                              ...
                              <ul role="list" className="mega-nav_list w-list-unstyled">
                                <li className="margin-bottom_none">
                                  <Link to="/services" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a01b1-d66a6ef8">
                                      <div>
                                ...
                                <li className="margin-bottom_none">
                                  <Link to="/services" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a01bc-d66a6ef8">
                                      <div>
                                ...
                                <li className="margin-bottom_none">
                                  <Link to="/services" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a01c7-d66a6ef8">
                                      <div>
                              ...
                              <ul role="list" className="mega-nav_list w-list-unstyled">
                                <li className="margin-bottom_none">
                                  <Link to="/services" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a01d6-d66a6ef8">
                                      <div>
                                ...
                                <li className="margin-bottom_none">
                                  <Link to="/services" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a01e1-d66a6ef8">
                                      <div>
                                ...
                                <li className="margin-bottom_none">
                                  <Link to="/services" className="mega-nav_link-item w-inline-block">
                                    ...
                                    <div id="w-node-_61be48fd-08da-7879-1198-67c4146a01ec-d66a6ef8">
                                      <div>
