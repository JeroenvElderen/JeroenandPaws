  ...
  <footer className="footer is-inverse">
    <div className="container">
      <div className="w-layout-grid grid_5-col gap-small">
        ...
        >
          <Link to="/" className="logo w-inline-block">
            ...
            <div className="paragraph_xlarge margin-bottom_none text_all-caps" data-brand-name="true">
              Jeroen &amp; Paws
            </div>
          </Link>
          <ul className="footer_icon-group margin_top-auto w-list-unstyled" role="list" aria-label="Social media links">
        ...
        <ul className="margin-bottom_none w-list-unstyled" role="list">
          <li>
      ...
      <div className="footer_bottom">
        ...
        <ul className="button-group gap-xsmall margin-top_none w-list-unstyled" role="list">
          <li className="margin-bottom_none">
            <a href="#" className="footer_link on-inverse w-inline-block">
              <div>Privacy</div>
            </a>
