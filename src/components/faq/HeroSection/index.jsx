            ...
            <nav className="accordion_content w-dropdown-list">
              <div className="padding_xsmall padding-horizontal_none">
                <div className="rich-text w-richtext">
                  <p>
                    Every dog is unique, so I use positive, balanced training tailored to your dog’s needs. My approach is gentle,
                    consistent, and always focused on building trust and confidence.
                  </p>
                </div>
              </div>
            </nav>
          ...
          <div data-delay="0" data-hover="false" className="accordion is-transparent w-dropdown">
            ...
            <nav className="accordion_content w-dropdown-list">
              <div className="padding_xsmall padding-horizontal_none">
                <div className="rich-text w-richtext">
                  <p>
                    Walks and drop-ins are flexible—choose from 30, 45, or 60 minutes. I make sure your dog gets exercise,
                    enrichment, and plenty of attention, whether it’s a quick stroll or a longer adventure.
                  </p>
                </div>
              </div>
            </nav>
          ...
          <div data-delay="0" data-hover="false" className="accordion is-transparent w-dropdown">
            ...
            <nav className="accordion_content w-dropdown-list">
              <div className="padding_xsmall padding-horizontal_none">
                <div className="rich-text w-richtext">
                  <p>
                    Boarding and day care offer a safe, structured, and fun environment. Your dog will enjoy playtime, rest, and
                    personalized care, just like they would at home.
                  </p>
                </div>
              </div>
            </nav>
          ...
          <div data-delay="0" data-hover="false" className="accordion is-transparent w-dropdown">
            ...
            <nav className="accordion_content w-dropdown-list">
              <div className="padding_xsmall padding-horizontal_none">
                <div className="rich-text w-richtext">
                  <p>
                    Absolutely! I’m experienced with dogs of all ages, breeds, and temperaments—including those with special needs.
                    Just let me know your dog’s routine, and I’ll make sure they feel comfortable and secure.
                  </p>
                </div>
              </div>
            </nav>
