  ...
  <section data-copilot="true" className="section overflow_hidden">
    <div className="container">
      ...
      <div
        ...
        data-infinite="true"
        data-nav-spacing="0"
        data-w-id="0d14ee74-34c7-37d2-a6cb-302ae410abf1"
      >
            ...
            <div className="card overflow_hidden backdrop-filter_blur">
              <div>
                <div className="card_body padding-bottom_none">
                  ...
                  <p>
                    Our training sessions are designed to meet your dog's unique needs, ensuring they learn in a way that's both
            ...
            <div className="card overflow_hidden backdrop-filter_blur">
              <div>
                <div className="card_body padding-bottom_none">
                  ...
                  <p>From short strolls to extended adventures, our walks are perfect for keeping your dog happy and healthy.</p>
                  <br />
                  <p>Explore options</p>
                </div>
                <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium">
            ...
            <div className="card overflow_hidden backdrop-filter_blur">
              <div>
                <div className="card_body padding-bottom_none">
                  ...
                  <p>A safe and loving environment for your dog while you're away, with all the comforts of home.</p>
                  <br />
                  <p>Book now</p>
                </div>
                <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium">
                  <img
                    ...
                    alt="image of children playing in a daycare setting"
                    loading="lazy"
                    width="405"
                    height="405"
                    data-aisg-image-id="118f6e48-7004-44f1-a3e0-8c61756fbbaf"
                    className="image_cover"
                  />
                </div>
              </div>
            ...
            <div className="card overflow_hidden backdrop-filter_blur">
              <div>
                <div className="card_body padding-bottom_none">
                  ...
                  <p>
                    Fun-filled days with plenty of play and socialization, ensuring your dog is well-cared for while you're at
                    work.
                  </p>
                  <br />
                  <p>Join us</p>
                ...
                <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium">
                  <img
                    ...
                    width="405"
                    height="405"
                    data-aisg-image-id="5444df09-ff30-43c9-af0d-bfe7e0d0dbb8"
                    className="image_cover"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium">
                  <img
                    ...
                    alt="[background image] of a chic pet lounging area"
                    loading="lazy"
                    width="405"
                    height="405"
                    data-aisg-image-id="289bc705-8882-489e-ba66-bef5b9704ca4"
                    className="image_cover"
                  />
                </div>
              </div>
        ...
        <div className="slider_arrow is-previous is-bottom-center w-slider-arrow-left" data-hide-text="true">
