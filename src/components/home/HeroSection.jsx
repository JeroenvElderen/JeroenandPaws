const HeroSection = () => (
  <header className="section padding_none text-color_on-overlay is-inverse">
    <div className="w-layout-grid grid_1-col">
      <div
        id="w-node-_83130efd-cc89-3e63-e012-238651cb9c90-51cb9c8e"
        className="position_relative min-height_100dvh w-node-_74183d39-97ba-696d-d9e0-d3e4e5d79529-055fd1ce"
      >
        <img
          width="1596"
          height="870"
          alt="image of the clinic reception area (for a veterinary clinic)"
          src="images/d1c5edae-66f0-4727-a854-02ccbbab7dc4.avif"
          loading="lazy"
          data-aisg-image-id="a1bf0ca8-09f4-44de-9832-4e64dd4c87ad"
          className="image_cover position_absolute radius_all-0"
        />
        <div className="overlay_opacity-middle mask_top">
          Step into a world where your dog's joy and well-being are our mission. Our tailored services ensure every pet feels
      ...
      >
        <div className="header is-2-col">
          <h1 className="heading_h1 margin-bottom_none text-white">Caring for your pet with expertise and love</h1>
          <div
          ...
          >
            <p className="paragraph_large text-white">
              Whether it's personalized training or a fun-filled daycare, we nurture an environment where your dog thrives. Count on
