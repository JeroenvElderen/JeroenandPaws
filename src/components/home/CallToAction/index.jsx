const CallToAction = () => (
  <section data-copilot="true" className="section padding_none">
    <div className="w-layout-grid grid_1-col">
      <div
        className="position_relative w-node-_851fc987-fbf0-69dc-8fc4-d770671b8b0d-055fd1ce"
        id="w-node-_05e54f8c-7d0c-01e1-5321-d818b7d69662-5ebb016a"
      >
        <img
          src="/images/490c688c-e948-444d-8655-990a7271d634.avif"
          alt="[digital project] image of editing software on a screen (for a music studio)"
          loading="lazy"
          width="1596"
          height="641"
          data-aisg-image-id="147b8067-6f19-4009-a795-92e9ffdd472d"
            ...
            <div className="w-layout-grid grid_3-col tablet-1-col gap-medium">
              ...
              <div className="image-ratio_auto">
                <img
                  ...
                  alt="image of distillery community involvement"
                  loading="lazy"
                  width="352"
                  height="289"
                  data-aisg-image-id="c638f4da-0930-4333-99de-1f1bddf95277"
