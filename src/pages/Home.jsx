  ...
  return (
    <>
      <div className="nav is-accent-primary">
          <div data-duration="400" data-animation="default" data-easing2="ease" data-easing="ease" data-collapse="medium" role="banner" data-no-scroll="1" className="nav_container w-nav">
                    ...
                    <div data-delay="0" data-hover="false" className="nav_dropdown-menu w-dropdown">
                      ...
                      <nav className="mega-nav_dropdown-list w-dropdown-list">
                        <div className="mega-nav_dropdown-list-wrapper">
                          <ul role="list" className="grid_3-col tablet-1-col gap-medium margin-bottom_none w-list-unstyled">
                            ...
                            <li id="w-node-_61be48fd-08da-7879-1198-67c4146a01f2-d66a6ef8" className="flex_horizontal w-node-_41e4cb1a-a620-245f-7f74-dc8693dc67af-93dc6729">
                              <a href="#" className="card-link is-inverse flex-child_expand w-inline-block">
        ...
        <header className="section padding_none text-color_on-overlay is-inverse">
          <div className="w-layout-grid grid_1-col">
            <div id="w-node-_83130efd-cc89-3e63-e012-238651cb9c90-51cb9c8e" className="position_relative min-height_100dvh w-node-_74183d39-97ba-696d-d9e0-d3e4e5d79529-055fd1ce"><img width="1596" height="870" alt="image of the clinic reception area (for a veterinary clinic)" src="images/d1c5edae-66f0-4727-a854-02ccbbab7dc4.avif" loading="lazy" data-aisg-image-id="a1bf0ca8-09f4-44de-9832-4e64dd4c87ad" className="image_cover position_absolute radius_all-0" />
            ...
            <div id="w-node-_83130efd-cc89-3e63-e012-238651cb9c93-51cb9c8e" className="container position_relative padding-bottom_large z-index_2 w-node-_74183d39-97ba-696d-d9e0-d3e4e5d79533-055fd1ce">
              <div className="header is-2-col">
                ...
                <div id="w-node-b44b49b5-d3e6-a05f-997e-8ac7efbac3da-51cb9c8e" className="flex_vertical gap-xsmall w-node-_74183d39-97ba-696d-d9e0-d3e4e5d79531-055fd1ce">
                  ...
                  <div className="button-group">
                    <a href="#" className="button on-inverse w-button">Discover more</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section data-copilot="true" className="section">
          <div className="container">
            <div className="header">
              <h2 className="heading_h2 max-width_large">Welcome to your dog&#x27;s second home</h2>
            </div>
            <div id="w-node-c566b793-7ed4-f098-3301-ccfdd3a617bc-d3a617ba" className="w-layout-grid grid_6-col gap-small w-node-_1a6e1d88-5744-48ea-d198-9a7dc9601d54-055fd1ce">
              <div id="w-node-c566b793-7ed4-f098-3301-ccfdd3a617bd-d3a617ba" className="card w-node-_1a6e1d88-5744-48ea-d198-9a7dc9601d2d-055fd1ce">
                <div className="card_body">
                  <div className="w-layout-grid grid_2-col tablet-1-col gap-small">
                    <div id="w-node-c566b793-7ed4-f098-3301-ccfdd3a617c1-d3a617ba" className="w-node-_1a6e1d88-5744-48ea-d198-9a7dc9601d28-055fd1ce">
                      <h3 className="heading_h4">Tailored dog care</h3>
                      ...
                      <div className="button-group">
                        <a href="#" className="button w-button">Explore services</a>
                      </div>
                    </div>
                    <div className="image-ratio_auto"><img width="347" height="255" alt="image of a pet training class" src="images/0eb7d340-9b38-4395-9a37-4ed50fff3c30.avif" loading="lazy" data-aisg-image-id="900a04ad-6748-45c2-bdcb-93a2ac449288" className="image image_cover" /></div>
                  </div>
                </div>
              </div>
              <div id="w-node-c566b793-7ed4-f098-3301-ccfdd3a617d9-d3a617ba" className="card w-node-_1a6e1d88-5744-48ea-d198-9a7dc9601d4a-055fd1ce">
                <div className="card_body">
                  <div className="w-layout-grid grid_2-col tablet-1-col gap-small">
                    <div className="image-ratio_auto"><img width="347" height="249" alt="image of an animal adoption event" src="images/ec54483c-b13a-4dfd-88da-91980f680916.avif" loading="lazy" data-aisg-image-id="1c895c37-6763-4962-a5e5-03d232e6de78" className="image_cover" /></div>
                    <div id="w-node-e1d6f978-b400-4ad5-acf8-8869285ac4d3-d3a617ba" className="w-node-_1a6e1d88-5744-48ea-d198-9a7dc9601d47-055fd1ce">
                      <h3 className="heading_h4">Comprehensive care</h3>
                      ...
                      <a href="#" className="button margin-top_small w-button">Contact us</a>
                    </div>
                  </div>
                </div>
              </div>
              <div id="w-node-c566b793-7ed4-f098-3301-ccfdd3a617f5-d3a617ba" className="card w-node-_1a6e1d88-5744-48ea-d198-9a7dc9601d53-055fd1ce">
                <div className="card_body">
                  <div className="margin_bottom-auto">
                    <h3 className="heading_h4">Passionate pet care</h3>
                    <p className="paragraph_small margin-bottom_none">Join a community of pet lovers who trust us to care for their dogs with love and expertise.</p>
                  </div>
                  <div className="image-ratio_2x3 margin-top_xsmall"><img width="299" height="448" alt="[background image] of a busy pet store environment" src="images/f0056c3e-db64-4fae-a858-84b4c370a6a6.avif" loading="lazy" data-aisg-image-id="6fe6aa77-d179-4e0b-90f4-3e55c4498c83" className="image_cover" /></div>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="card overflow_hidden backdrop-filter_blur">
                    <div>
                      <div className="card_body padding-bottom_none">
                        ...
                        <p>Our training sessions are designed to meet your dog&#x27;s unique needs, ensuring they learn in a way that&#x27;s both effective and enjoyable.</p><br />
                        <p>Learn more</p>
                      </div>
                      <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium"><img width="405" height="405" alt="image of animal training sessions for a animal welfare nonprofit" src="images/0a9b8c7a-1447-4104-8895-8fe3cbbe946c.avif" loading="lazy" data-aisg-image-id="c56ebe89-25cf-4b6d-8068-7636c86bdcdf" className="image_cover" /></div>
                    </div>
                  </div>
                </div>
                <div className="ix_card-deck-space height_100percent w-slide">
                  <div className="card overflow_hidden backdrop-filter_blur">
                    <div>
                      <div className="card_body padding-bottom_none">
                        ...
                        <p>From short strolls to extended adventures, our walks are perfect for keeping your dog happy and healthy.</p><br />
                        <p>Explore options</p>
                      </div>
                      <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium"><img width="405" height="405" alt="image of an animal adoption event" src="images/99a7405c-2283-456c-bc54-94034e028144.avif" loading="lazy" data-aisg-image-id="5b67c60d-5ded-45db-861a-7a2ca8ccea63" className="image_cover" /></div>
                    </div>
                  </div>
                </div>
                <div className="ix_card-deck-space height_100percent w-slide">
                  <div className="card overflow_hidden backdrop-filter_blur">
                    <div>
                      <div className="card_body padding-bottom_none">
                        ...
                        <p>A safe and loving environment for your dog while you&#x27;re away, with all the comforts of home.</p><br />
                        <p>Book now</p>
                      </div>
                      <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium"><img width="405" height="405" alt="image of children playing in a daycare setting" src="images/25c0c9d1-2e99-484e-817b-bf1e3505d5e8.avif" loading="lazy" data-aisg-image-id="118f6e48-7004-44f1-a3e0-8c61756fbbaf" className="image_cover" /></div>
                    </div>
                  </div>
                </div>
                <div className="ix_card-deck-space height_100percent w-slide">
                  <div className="card overflow_hidden backdrop-filter_blur">
                    <div>
                      <div className="card_body padding-bottom_none">
                        ...
                        <p>Fun-filled days with plenty of play and socialization, ensuring your dog is well-cared for while you&#x27;re at work.</p><br />
                        <p>Join us</p>
                      </div>
                      <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium"><img width="405" height="405" alt="image of a pet training class" src="images/a58085e9-4555-461c-9f59-6029e44d0a55.avif" loading="lazy" data-aisg-image-id="5444df09-ff30-43c9-af0d-bfe7e0d0dbb8" className="image_cover" /></div>
                    </div>
                  </div>
                </div>
                <div className="ix_card-deck-space height_100percent w-slide">
                  <div className="card overflow_hidden backdrop-filter_blur">
                    <div>
                      <div className="card_body padding-bottom_none">
                        ...
                        <p>Quick visits to check in on your pet, providing them with the attention and care they need.</p><br />
                        <p>Schedule a visit</p>
                      </div>
                      <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium"><img width="405" height="405" alt="[background image] of a chic pet lounging area" src="images/bc30b5db-c4fa-466a-a797-7ef1e270262b.avif" loading="lazy" data-aisg-image-id="289bc705-8882-489e-ba66-bef5b9704ca4" className="image_cover" /></div>
                    </div>
                  </div>
                </div>
                <div className="ix_card-deck-space height_100percent w-slide">
                  <div className="card overflow_hidden backdrop-filter_blur">
                    <div>
                      <div className="card_body padding-bottom_none">
                        ...
                        <p>Expert care for dogs with specific needs, ensuring they receive the best possible attention.</p><br />
                        <p>Contact us</p>
                      </div>
                      <div className="image-ratio_1x1 margin-top_xsmall margin-left_medium"><img width="405" height="405" alt="image of a vet assisting an animal" src="images/c3d7a736-6df4-460c-a24c-920315c472d6.avif" loading="lazy" data-aisg-image-id="adfe4de3-4bd2-485f-9f46-d2394c32d69a" className="image_cover" /></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section data-copilot="true" className="section padding_none">
          <div className="w-layout-grid grid_4-col">
            <div id="w-node-_25aa69ea-f6ff-a983-3b30-a346b1836f6c-7ac2c669" className="image-ratio_3x2 radius_all-0 w-node-bd678469-22c4-f2df-4448-11fb241a1843-055fd1ce"><img width="1193" height="795" alt="image of a vet assisting an animal" src="images/c3d7a736-6df4-460c-a24c-920315c472d6.avif" loading="lazy" data-aisg-image-id="adfe4de3-4bd2-485f-9f46-d2394c32d69a" className="image_cover" /></div>
              ...
              <div className="w-layout-grid grid_2-col tablet-1-col margin-bottom_xxlarge position_relative">
                <div className="card">
                  <div className="card_body">
                    ...
                    <div className="button-group">
                      <a href="#" className="button w-button">Discover more</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="w-layout-grid grid_2-col tablet-1-col gap-large">
              ...
              <div className="w-layout-grid grid_2-col mobile-l-1-col gap-small">
                <div id="w-node-d6288141-3e37-a760-1f1f-3f87c261e1bc-0be05d1c" className="card w-node-f5984468-b07a-271c-06a7-f4645ab0ffc6-055fd1ce">
                  <div className="card_body_small">
                    <div className="flex_horizontal is-y-center gap-xsmall margin-bottom_xsmall">
                      <div className="avatar"><img width="64" height="64" alt="[headshot] image of a customer interacting with their pet (for a pet store)" src="images/0e44b64c-d3fe-4e4d-897a-5b42d9786cef.avif" loading="lazy" data-aisg-image-id="623c3d43-768f-414b-852a-083e1f87013b" className="image_cover" /></div>
                      <div>
                    ...
                    <p className="paragraph_small margin-bottom_none">The care and attention my dog received was exceptional. I felt at ease knowing he was in such capable hands.</p>
                  </div>
                </div>
                <div className="card">
                  <div className="card_body_small">
                    <div className="flex_horizontal is-y-center gap-xsmall margin-bottom_xsmall">
                      <div className="avatar"><img width="64" height="64" alt="[headshot] image of a happy pet owner after training" src="images/55eb9a74-4563-4656-8285-693f3bc4b759.avif" loading="lazy" data-aisg-image-id="40704ce3-ed2d-49cf-a08e-e9d9342031d5" className="image_cover" /></div>
                      <div>
                    ...
                    <p className="paragraph_small margin-bottom_none">Our dog has never been happier! The training sessions were fun and effective.</p>
                  </div>
                </div>
                <div id="w-node-_57b0b48d-fc7d-2a70-7d13-21713b2c2f03-0be05d1c" className="card w-node-f5984468-b07a-271c-06a7-f4645ab0ffe4-055fd1ce">
                  <div className="card_body_small">
                    <div className="flex_horizontal is-y-center gap-xsmall margin-bottom_xsmall">
                      <div className="avatar"><img width="64" height="64" alt="[headshot] image of customer with their pet" src="images/09861758-cd7a-47db-a18d-e8f951b34035.avif" loading="lazy" data-aisg-image-id="297669ea-6a3b-4f6f-bc0e-37985d9dabf9" className="image_cover" /></div>
                      <div>
                    ...
                    <p className="paragraph_small margin-bottom_none">The boarding service was a lifesaver during our vacation. Our dog was well cared for and loved.</p>
                  </div>
                </div>
                <div className="card">
                  <div className="card_body_small">
                    <div className="flex_horizontal is-y-center gap-xsmall margin-bottom_xsmall">
                      <div className="avatar"><img width="64" height="64" alt="[headshot] image of customer (for a mosque)" src="images/f52d8d29-fbc0-41f0-b455-b872016a4be2.avif" loading="lazy" data-aisg-image-id="389105fd-73fb-4c79-86a7-05628ca677fd" className="image_cover" /></div>
                      <div>
                    ...
                    <p className="paragraph_small margin-bottom_none">I highly recommend their services. The team is professional and truly cares about each pet.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section data-copilot="true" className="section padding_none">
          <div className="w-layout-grid grid_1-col">
            <div id="w-node-_05e54f8c-7d0c-01e1-5321-d818b7d69662-5ebb016a" className="position_relative w-node-_851fc987-fbf0-69dc-8fc4-d770671b8b0d-055fd1ce"><img width="1596" height="641" alt="[digital project] image of editing software on a screen (for a music studio)" src="images/490c688c-e948-444d-8655-990a7271d634.avif" loading="lazy" data-aisg-image-id="147b8067-6f19-4009-a795-92e9ffdd472d" className="image_cover position_absolute" /></div>
            <div id="w-node-_05e54f8c-7d0c-01e1-5321-d818b7d69664-5ebb016a" className="container position_relative padding_section events_none w-node-_851fc987-fbf0-69dc-8fc4-d770671b8b2e-055fd1ce">
              <div className="card">
                <div className="card_body events_auto">
                  <div className="w-layout-grid grid_3-col tablet-1-col gap-medium">
                    <div id="w-node-_86672d52-e14b-c232-ad3a-e062de5187ae-5ebb016a" className="header margin-bottom_none w-node-_851fc987-fbf0-69dc-8fc4-d770671b8b28-055fd1ce">
                    ...
                    <div className="image-ratio_auto"><img width="352" height="289" alt="image of distillery community involvement" src="images/6112f29d-dcad-4748-87cd-799ae8f92763.avif" loading="lazy" data-aisg-image-id="c638f4da-0930-4333-99de-1f1bddf95277" className="image_cover" /></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section data-copilot="true" className="section">
          <div className="container is-small">
            <div id="w-node-_1b9fe946-f76f-93ba-3eaa-8c8d6d52a282-6d52a280" className="header is-align-center w-node-e5c63cf8-d464-4b5c-779f-87db4b792fc8-055fd1ce">
              <h2>Welcome to your dog&#x27;s second home</h2>
              <p className="subheading">Discover our personalized care and training services for your furry friend.</p>
            </div>
            <div id="w-node-_1b9fe946-f76f-93ba-3eaa-8c8d6d52a287-6d52a280" className="flex_vertical w-node-e5c63cf8-d464-4b5c-779f-87db4b792ff1-055fd1ce">
              <div data-delay="0" data-hover="false" className="accordion is-transparent w-dropdown">
                <div className="accordion_toggle-transparent w-dropdown-toggle">
                  <div className="accordion_icon w-icon-dropdown-toggle">What services do you offer for dogs?</div>
                  <div className="paragraph_large margin-bottom_none">We provide training, walking, boarding, and day care.</div>
                </div>
                <nav className="accordion_content w-dropdown-list">
                  <div className="padding_xsmall padding-horizontal_none">
                    <div className="rich-text w-richtext">
                      <p>Our services are tailored to meet the unique needs of each dog, ensuring they receive the best care possible.</p>
                    </div>
                  </div>
                </nav>
              </div>
              <div data-delay="0" data-hover="false" className="accordion is-transparent w-dropdown">
                <div className="accordion_toggle-transparent w-dropdown-toggle">
                  <div className="accordion_icon w-icon-dropdown-toggle">How experienced are you with dog care?</div>
                  <div className="paragraph_large margin-bottom_none">I have over 7 years of experience and a certification in Animal Care.</div>
                </div>
                <nav className="accordion_content w-dropdown-list">
                  <div className="padding_xsmall padding-horizontal_none">
                    <div className="rich-text w-richtext">
                      <p>My background includes working with police, sled, and guide dogs.</p>
                    </div>
                  </div>
                </nav>
              </div>
              <div data-delay="0" data-hover="false" className="accordion is-transparent w-dropdown">
                <div className="accordion_toggle-transparent w-dropdown-toggle">
                  <div className="accordion_icon w-icon-dropdown-toggle">What makes your services unique?</div>
                  <div className="paragraph_large margin-bottom_none">I offer a compassionate, personalized approach to each dog&#x27;s care.</div>
                </div>
                <nav className="accordion_content w-dropdown-list">
                  <div className="padding_xsmall padding-horizontal_none">
                    <div className="rich-text w-richtext">
                      <p>Every dog is treated like family, ensuring they feel happy and secure.</p>
                    </div>
                  </div>
                </nav>
              </div>
              <div data-delay="0" data-hover="false" className="accordion is-transparent w-dropdown">
                <div className="accordion_toggle-transparent w-dropdown-toggle">
                  <div className="accordion_icon w-icon-dropdown-toggle">Can you accommodate special needs?</div>
                  <div className="paragraph_large margin-bottom_none">Yes, I tailor my methods to fit each dog&#x27;s individual needs.</div>
                </div>
                <nav className="accordion_content w-dropdown-list">
                  <div className="padding_xsmall padding-horizontal_none">
                    <div className="rich-text w-richtext">
                      <p>Whether it&#x27;s training or day care, I ensure a safe and loving environment.</p>
                    </div>
                  </div>
                </nav>
              </div>
            ...
            <div className="w-layout-grid grid_5-col gap-small">
              <div id="w-node-_851d61a1-1dad-400a-5b6a-92b99f998536-b17c3d94" className="flex_vertical gap-small w-node-_8489c8c1-07dc-6ab4-cde4-f5c814a2d0ce-14a2d0cb">
                ...
                <ul role="list" aria-label="Social media links" className="footer_icon-group margin_top-auto w-list-unstyled">
                  <li className="margin-bottom_none">
                    <a href="#" className="footer_icon-link w-inline-block"><svg width="100%" height="100%" viewBox="0 0 16 16">
