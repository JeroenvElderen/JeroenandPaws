  ...
  <main id="main" className="sg_page-content">
            <div id="Foundation">
              <div className="container">
                <header className="sg_group-hero sg_first">
                  <h1 className="heading_h1">Foundations</h1>
                  <p className="subheading">This style guide is a collection of elements and components with brand colors and typography applied. To change any colors or values use Variables (V) panel. <br /></p>
                  <div className="divider margin-bottom_small"></div>
                    ...
                    <div className="grid_2-col gap-small tablet-1-col">
                      <div id="w-node-_6401b070-0ac8-bcf0-2647-73725f5e5b6e-055fd1d7">
                        <div className="eyebrow margin-bottom_xxsmall">Built with:</div><svg viewBox="0 0 951 255" width="100%" height="100%" className="logo is-medium">
                          ...
                          <path fill-rule="evernodd" clip-rule="evernodd" d="M251 41.0181H359.534V67.9891H280.924V111.995H355.021V138.966H280.924V208.523H251V41.0181Z" fill="currentColor"></path>
                          <path fill-rule="evernodd" clip-rule="evernodd" d="M375.735 40.8674H404.234V208.523H375.735V40.8674Z" fill="currentColor"></path>
                          <path fill-rule="evernodd" clip-rule="evernodd" d="M480 211.333C468.482 211.333 458.172 208.822 449.068 203.801C440.033 198.709 432.93 191.694 427.758 182.751C422.656 173.738 420.103 163.523 420.103 152.105C420.103 140.616 422.656 130.366 427.758 121.354C432.93 112.273 440.033 105.222 449.068 100.201C458.172 95.1787 468.482 92.6679 480 92.6679C491.586 92.6679 501.93 95.1787 511.034 100.201C520.207 105.222 527.344 112.239 532.447 121.251C537.551 130.263 540.136 140.546 540.206 152.105C540.136 163.523 537.551 173.738 532.447 182.751C527.413 191.694 520.31 198.709 511.137 203.801C501.964 208.822 491.586 211.333 480 211.333ZM480 185.433C486.068 185.433 491.447 184.058 496.138 181.306C500.826 178.486 504.448 174.564 506.999 169.542C509.551 164.452 510.827 158.639 510.827 152.105C510.827 145.499 509.551 139.652 506.999 134.562C504.448 129.471 500.826 125.55 496.138 122.798C491.447 119.978 486.068 118.568 480 118.568C473.999 118.568 468.654 119.978 463.966 122.798C459.344 125.55 455.759 129.471 453.206 134.562C450.654 139.652 449.413 145.499 449.482 152.105C449.482 158.639 450.758 164.452 453.311 169.542C455.93 174.564 459.517 178.486 464.069 181.306C468.689 184.058 473.999 185.433 480 185.433Z" fill="currentColor"></path>
                          <path fill-rule="evernodd" clip-rule="evernodd" d="M570.712 95.1456H539.263L573.297 208.858H600.814L623.2 136.23L647.361 208.858H674.468L708.61 95.1456H680.162L660.796 165.925L639.406 95.1456H611.884L590.589 167.483L570.712 95.1456Z" fill="currentColor"></path>
                          <path fill-rule="evernodd" clip-rule="evernodd" d="M716.438 40.3104H744.937V141.485L788.873 94.4036H825.447L776.523 145.98L828.534 207.966H790.773L745.412 150.002H744.937V207.966H716.438V40.3104Z" fill="currentColor"></path>
                          <path fill-rule="evernodd" clip-rule="evernodd" d="M834.972 94.9606H863.471V208.523H834.972V94.9606ZM830.935 56.3967C830.935 51.8226 832.597 47.8795 835.922 44.5673C839.405 41.0973 843.759 39.3623 848.984 39.3623C854.209 39.3623 858.563 41.0184 862.046 44.3307C865.688 47.4852 867.509 51.5072 867.509 56.3967C867.509 61.2862 865.688 65.387 862.046 68.6993C858.563 71.8538 854.209 73.431 848.984 73.431C843.759 73.431 839.405 71.7749 835.922 68.4627C832.597 64.9927 830.935 60.9707 830.935 56.3967Z" fill="currentColor"></path>
                          <path fill-rule="evernodd" clip-rule="evernodd" d="M925.401 94.9601H951V119.093H925.401V168.776C925.401 174.454 926.431 178.949 928.489 182.261C930.705 185.574 934.98 187.23 941.313 187.23C943.846 187.23 946.617 186.994 949.625 186.521C950.099 186.421 950.557 186.311 951 186.196V209.522C949.332 209.91 947.529 210.209 945.588 210.416C941.313 211.047 937.513 211.362 934.188 211.362C926.588 211.362 920.334 210.494 915.426 208.759C910.677 207.182 906.877 204.737 904.027 201.426C901.336 197.956 899.435 193.697 898.327 188.65C897.377 183.602 896.902 177.767 896.902 171.142V119.093H873.39V94.9601H896.902V62.0745H925.401V94.9601Z" fill="currentColor"></path>
                        </svg>
                      </div>
                      <div id="w-node-_6401b070-0ac8-bcf0-2647-73725f5e5b7c-055fd1d7" className="margin-top_xxsmall">
                        <div className="flex-child_expand">
                          <p className="text-width_medium">Flowkit is a Webflow&#x27;s utility-first CSS framework that helps you build websites quickly by applying pre-made CSS in Webflow.</p>
                        </div>
              ...
              <section id="Foundation-Typography" className="section is-secondary">
                <div className="container">
                  <div className="sg_section-heading-wrapper">
                    <div className="sg_heading-row">
                      <div>
                        <h2>Typography</h2>
                        <p className="text-color_secondary">Headings tags and classes are connected through the variables which helps to keep them consistent.</p>
                      </div>
                  ...
                  <div className="flex_vertical gap-large">
                    <div>
                      <div className="sg_section-heading-wrapper">
                        <div className="paragraph_xlarge">Headings</div>
                      </div>
                      <div className="sg_card-wrapper">
                        ...
                        <div className="sg_table-row">
                          <div className="sg_table-cell-title">
                            <div>Heading Huge</div>
                          </div>
                          <div className="sg_table-cell sg_align-bottom">
                            <p className="heading_huge">Voice of a brand</p>
                          </div>
                        </div>
                        <div className="sg_divider"></div>
                        <div className="sg_table-row">
                          <div className="sg_table-cell-title">
                            <div>Heading H1</div>
                          </div>
                          <div className="sg_table-cell sg_align-bottom">
                            <h1 className="heading_h1">Headings embody the voice of a brand</h1>
                          </div>
                        </div>
                        <div className="sg_divider"></div>
                        <div className="sg_table-row">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <h2 className="heading_h2">Headings embody the voice of a brand</h2>
                          </div>
                        </div>
                        <div className="sg_divider"></div>
                        <div className="sg_table-row">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <h3 className="heading_h3">Headings embody the voice of a brand</h3>
                          </div>
                        </div>
                        <div className="sg_divider"></div>
                        <div className="sg_table-row">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <h4 className="heading_h4">Headings embody the voice of a brand</h4>
                          </div>
                        </div>
                        <div className="sg_divider"></div>
                        <div className="sg_table-row">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <h5 className="heading_h5">Headings embody the voice of a brand</h5>
                          </div>
                        </div>
                        <div className="sg_divider"></div>
                        <div className="sg_table-row">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <h6 className="heading_h6">Headings embody the voice of a brand</h6>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div className="sg_section-heading-wrapper">
                        <div className="paragraph_xlarge">Paragraph</div>
                      </div>
                      <div className="sg_card-wrapper">
                        <div className="sg_table-row sg_table-head">
                          <div className="sg_table-cell-title">
                        ...
                        <div className="sg_table-row sg_border-bottom">
                          <div className="sg_table-cell-title">
                            <div>Paragraph xxlarge</div>
                          </div>
                          <div className="sg_table-cell sg_align-bottom">
                            <p className="paragraph_xxlarge">A well-crafted typeface is more than just a collection of letters— it is the fingerprint of great design, carrying within it the essence of a brand, a message, and a mood. </p>
                          </div>
                        </div>
                        <div className="sg_table-row sg_border-bottom">
                          <div className="sg_table-cell-title">
                            <div>Paragraph xlarge</div>
                          </div>
                          <div className="sg_table-cell sg_align-bottom">
                            <p className="paragraph_xlarge">A well-crafted typeface is more than just a collection of letters — it is the fingerprint of great design, carrying within it the essence of a brand, a message, and a mood. </p>
                          </div>
                        </div>
                        <div className="sg_table-row sg_border-bottom">
                          <div className="sg_table-cell-title">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <p className="paragraph_large">A well-crafted typeface is more than just a collection of letters — it is the fingerprint of great design, carrying within it the essence of a brand, a message, and a mood. </p>
                          </div>
                        </div>
                        <div className="sg_table-row sg_border-bottom">
                          <div className="sg_table-cell-title">
                            <div>Paragraph (Default)</div>
                          </div>
                          <div className="sg_table-cell sg_align-bottom">
                            <p className="paragraph">A well-crafted typeface is more than just a collection of letters—it is the fingerprint of great design, carrying within it the essence of a brand, a message, and a mood. </p>
                          </div>
                        </div>
                        <div className="sg_table-row">
                          <div className="sg_table-cell-title">
                            <div>Paragraph small</div>
                          </div>
                          <div className="sg_table-cell sg_align-bottom">
                            <p className="paragraph_small">A well-crafted typeface is more than just a collection of letters—it is the fingerprint of great design, carrying within it the essence of a brand, a message, and a mood. </p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div className="paragraph_xlarge">Other text elements </div>
                      <div className="sg_card-wrapper">
                        <div className="sg_table-row sg_table-head">
                          <div className="sg_table-cell-title">
                            <div className="sg_table-header-heading">Title</div>
                        ...
                        <div className="sg_table-row sg_border-bottom">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <div className="subheading">A well-crafted typeface is more than just a collection of letters—it is the fingerprint of great design, carrying within it the essence of a brand, a message, and a mood. </div>
                          </div>
                        </div>
                        <div className="sg_table-row sg_border-bottom">
                          <div className="sg_table-cell-title">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <blockquote>Never before have so many people had so much access to such a powerful medium for building businesses; sharing knowledge, insight, and creativity; and creating communities.</blockquote>
                          </div>
                        </div>
                        <div className="sg_table-row sg_border-bottom">
                          <div className="sg_table-cell-title">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <div className="eyebrow">Adventure Awaits</div>
                          </div>
                        </div>
                        <div className="sg_table-row sg_border-bottom">
                          <div className="sg_table-cell-title">
                          ...
                          <div className="sg_table-cell sg_align-bottom">
                            <ul>
                              <li>Use white space to improve text legibility.</li>
                              <li>Make typography responsive for all screen sizes.</li>
                              <li>Use proper line spacing for easy readability.</li>
                            </ul>
                          </div>
                        </div>
                        <div className="sg_table-row">
                          <div className="sg_table-cell-title">
                            <div>List ordered</div>
                          </div>
                          <div className="sg_table-cell sg_align-bottom">
                            <ol>
                              <li>Use white space to improve text legibility.</li>
                              <li>Make typography responsive for all screen sizes.</li>
                              <li>Use proper line spacing for easy readability.<br /></li>
                            </ol>
                          </div>
                        </div>
                      </div>
              ...
              <section id="Foundation-Spacing" className="section is-secondary">
                <div className="container">
                  <div className="sg_section-heading-wrapper">
                    <div className="sg_heading-row">
                      <div>
                        <h2>Spacing</h2>
                        <p className="text-color_secondary">Spacing styles such as margins, paddings, and gaps are using predefined set of REM-based variables and applied directly to component classes. </p>
                      </div>
                  ...
                  <div className="sg_grid">
                    <div className="sg_card-wrapper">
                      <div>
                        <div className="paragraph_large">Gap</div>
                        <p className="text-color_secondary">Set of variables used for grid and flex layouts. <br />Read docs</p>
                        <div id="w-node-_6401b070-0ac8-bcf0-2647-73725f5e5d77-055fd1d7" className="flex_vertical gap-xsmall">
                          <div className="sg_table-row sg_table-head">
                            <div className="sg_table-cell sg_cell-small">
                              <div className="sg_table-header-heading">Variable</div>
                            </div>
                            <div className="sg_table-cell">
                              <div className="sg_table-header-heading">Preview</div>
                            </div>
                          ...
                          <div className="sg_table-row">
                            ...
                            <div className="sg_table-cell">
                              <div className="flex_horizontal">
                                <div className="sg_spacing-demo"></div>
                                <div className="sg_spacing sg_gap-xxs"></div>
                                <div className="sg_spacing-demo"></div>
                              </div>
                            </div>
                          </div>
                          <div className="sg_table-row">
                            ...
                            <div className="sg_table-cell">
                              <div className="flex_horizontal">
                                <div className="sg_spacing-demo"></div>
                                <div className="sg_spacing sg_gap-xs"></div>
                                <div className="sg_spacing-demo"></div>
                              </div>
                            </div>
                          </div>
                          <div className="sg_table-row">
                            ...
                            <div className="sg_table-cell">
                              <div className="flex_horizontal">
                                <div className="sg_spacing-demo"></div>
                                <div className="sg_spacing sg_gap-sm"></div>
                                <div className="sg_spacing-demo"></div>
                              </div>
                            </div>
                          </div>
                          <div className="sg_table-row">
                            ...
                            <div className="sg_table-cell">
                              <div className="flex_horizontal">
                                <div className="sg_spacing-demo"></div>
                                <div className="sg_spacing sg_gap-md"></div>
                                <div className="sg_spacing-demo"></div>
                              </div>
                            </div>
                          </div>
                          <div className="sg_table-row">
                            ...
                            <div className="sg_table-cell">
                              <div className="flex_horizontal">
                                <div className="sg_spacing-demo"></div>
                                <div className="sg_spacing sg_gap-lg"></div>
                                <div className="sg_spacing-demo"></div>
                              </div>
                            </div>
                          </div>
                          <div className="sg_table-row">
                            ...
                            <div className="sg_table-cell">
                              <div className="flex_horizontal">
                                <div className="sg_spacing-demo"></div>
                                <div className="sg_spacing sg_gap-xl"></div>
                                <div className="sg_spacing-demo"></div>
                              </div>
                            </div>
                          </div>
                          <div className="sg_table-row">
                            ...
                            <div className="sg_table-cell">
                              <div className="flex_horizontal">
                                <div className="sg_spacing-demo"></div>
                                <div className="sg_spacing sg_gap-xxl"></div>
                                <div className="sg_spacing-demo"></div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="sg_card-wrapper">
                      <div>
                        <div className="paragraph_large">Spacing</div>
                        <p className="text-color_secondary">To keep spacing consistent, most of the text elements and components have spacing applied as margin or padding.</p>
                        <div id="w-node-_6401b070-0ac8-bcf0-2647-73725f5e5dc4-055fd1d7" className="flex_vertical gap-xxsmall">
                          <div className="sg_table-row sg_table-head">
                            <div className="sg_table-header-heading">Preview</div>
                          </div>
                          <div>
                            <div className="eyebrow">Adventure Awaits</div>
                            <h2>Headings embody the voice of a brand</h2>
                            <div className="subheading">A well-crafted typeface is more than just a collection of letters—it is the fingerprint of great design, carrying within it the essence of a brand, a message, and a mood. </div>
            ...
            <div id="Components">
              ...
              <section id="Components-Icons" className="section is-secondary">
                <div className="flex_horizontal flex_vertical gap-large">
                  <div className="container">
                    <div className="sg_section-heading-wrapper">
                      <div className="sg_heading-row">
                    ...
                    <div className="flex_vertical gap-large">
                      <div className="sg_card-wrapper">
                        <div className="sg_table-row sg_gap">
                          <div className="sg_table-col">
                            <div className="sg_table-header-heading">
                              <div>Extra Small</div>
                            </div>
              ...
              <section id="Components-Cards" className="section is-secondary">
                <div className="container">
                  <div className="sg_section-heading-wrapper">
                    <div className="sg_heading-row">
                      <h2>Cards</h2>
                  ...
                  <div className="flex_vertical gap-large">
                    <div className="grid_3-col gap-medium">
                      <div className="sg_table-col">
                        <div className="sg_table-cell sg_table-cell-title">
                          <div>Default Card</div>
                        </div>
                        <div className="card">
                          <div className="card_body_small">
                            <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                            <div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <div className="button-group">
                                <div className="text-button">
                                  <div className="display_inline-block">Read post</div>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="sg_table-col">
                        <div className="sg_table-cell sg_align-bottom sg_table-cell-title">
                          <div>Inverse Card</div>
                        </div>
                        <div className="card is-inverse">
                          <div className="card_body_small">
                            <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                            <div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <div className="button-group">
                                <div className="text-button on-inverse">
                                  <div className="display_inline-block">Read post</div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="sg_table-col">
                        ...
                        <div className="card is-accent-primary">
                          <div className="card_body_small">
                            <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                            <div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <div className="button-group">
                                <div className="text-button on-accent-primary">
                                  <div className="display_inline-block">Read post</div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="sg_table-col sg_accent-secondary-visibility">
                        ...
                        <div className="card is-accent-secondary">
                          <div className="card_body_small">
                            <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                            <div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <div className="button-group">
                                <div className="text-button on-accent-secondary">
                                  <div className="display_inline-block">Read post</div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="sg_table-col sg_accent-tertiary-visibility">
                        ...
                        <div className="card is-accent-tertiary">
                          <div className="card_body_small">
                            <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                            <div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <div className="button-group">
                                <div className="text-button on-accent-tertiary">
                                  <div className="display_inline-block">Read post</div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div className="sg_table-col">
                      <div className="sg_table-header-heading">On Secondary</div>
                      <div className="sg_card-wrapper sg_card-secondary">
                        <div className="flex_horizontal gap-small mobile-l-vertical">
                          <div className="card on-secondary">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p className="text-color_secondary">Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                            </div>
                          </div>
                          <div className="card on-secondary">
                            <div className="card_body">
                          ...
                          <div className="card on-secondary hide_mobile-l">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p className="text-color_secondary">Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                    ...
                    <div className="sg_table-col">
                      <div className="sg_table-header-heading">On Inverse</div>
                      <div className="sg_card-wrapper sg_card-invert">
                        <div className="flex_horizontal gap-small mobile-l-vertical">
                          ...
                          <div className="card on-inverse hide_mobile-l">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p>Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                    ...
                    <div className="sg_table-col">
                      <div className="sg_table-header-heading">On Accent Primary</div>
                      <div className="sg_card-wrapper sg_card-accent-primary">
                        <div className="flex_horizontal gap-small mobile-l-vertical">
                          <div className="card on-accent-primary">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p>Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                          ...
                          <div className="card on-accent-primary display_none_mobile-l">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p>Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                    ...
                    <div className="sg_table-col sg_accent-secondary-visibility">
                      <div className="sg_table-header-heading">On Accent Secondary</div>
                      <div className="sg_card-wrapper sg_card-accent-secondary">
                        <div className="flex_horizontal gap-small mobile-l-vertical">
                          <div className="card on-accent-secondary">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p>Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                          ...
                          <div className="card on-accent-secondary display_none_mobile-l">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p>Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                    ...
                    <div className="sg_table-col sg_accent-tertiary-visibility">
                      <div className="sg_table-header-heading">On Accent Tertiary</div>
                      <div className="sg_card-wrapper sg_card-accent-tertiary">
                        <div className="flex_horizontal gap-small mobile-l-vertical">
                          <div className="card on-accent-tertiary">
                            <div className="card_body">
                              <div className="image-ratio_3x2 margin-bottom_small"><img loading="lazy" src="https://uploads-ssl.webflow.com/663ae41a035a5092ac55e30d/663ae41a035a5092ac55e325_image_placeholder.svg" alt="" className="image image_cover" /></div>
                              <h4>A different heading, so it doesn&#x27;t look repetitive.</h4>
                              <p>Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
