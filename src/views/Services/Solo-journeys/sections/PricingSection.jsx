        ...
        <ul className="grid_3-col gap-xsmall text-align_center w-list-unstyled">
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/solo-journey-180">
                  Book Half-Day
                </Link>
              </div>
            </div>
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/solo-journey-360">
                  Book Full-Day
                </Link>
              </div>
            </div>
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/solo-journey-custom">
                  Plan Together
                </Link>
              </div>
            </div>
