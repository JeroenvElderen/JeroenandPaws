        ...
        <ul className="grid_4-col gap-xsmall text-align_center w-list-unstyled">
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/group-adventure-120">
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/group-adventure-240">
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/group-adventure-480">
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/group-adventure-custom">
