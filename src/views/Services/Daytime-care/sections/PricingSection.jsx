        ...
        <ul className="grid_3-col gap-xsmall text-align_center w-list-unstyled">
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/daytime-care-4h">
                  Book Half-Day
                </Link>
              </div>
            </div>
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/daytime-care-8h">
                  Book Full-Day
                </Link>
              </div>
            </div>
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/daytime-care-custom">
                  Plan Together
                </Link>
              </div>
            </div>
