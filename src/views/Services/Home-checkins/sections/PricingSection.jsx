        ...
        <ul className="grid_3-col gap-xsmall text-align_center w-list-unstyled">
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/home-check-in-30">
                  Book Check-In
                </Link>
              </div>
            </div>
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/home-check-in-60">
                  Book Extended Visit
                </Link>
              </div>
            </div>
          ...
          <li className="card on-secondary">
            <div className="card_body is-small">
              ...
              <div className="button-group is-align-center">
                <Link className="button w-button" href="/booking/home-check-in-custom">
                  Plan Together
                </Link>
              </div>
            </div>
